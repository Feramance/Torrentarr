...
Torrentarr provides dual endpoint patterns for flexibility:
...
```json
{
  ...
  "changelog_url": "https://github.com/Feramance/Torrentarr/releases/tag/v5.3.0",
...
2. Updates all child loggers (Torrentarr, Torrentarr.arr, Torrentarr.webui, etc.)
...
```json
{
  ...
  "warning": {
    ...
    "message": "Config version mismatch: found 5.8.8, expected 6.14.4.",
