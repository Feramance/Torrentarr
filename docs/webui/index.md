...
3. **Verify WebUI files exist:**
    ...
    ```bash
    # Check static files
    ls -la /path/to/Torrentarr/static/
...
1. **Check file permissions:**
    ...
    ```bash
    # Ensure Torrentarr can write to config
...
- [CLI Reference](../getting-started/index.md#command-line-reference) - Command-line options
- [Glossary](../faq.md#glossary) - Terms and definitions
...
- **GitHub Discussions** - [Ask questions, share tips](https://github.com/Feramance/Torrentarr/discussions)
...
3. **Torrentarr Version** - Found in WebUI header
...
Have an idea for the WebUI? [Open a discussion](https://github.com/Feramance/Torrentarr/discussions/categories/ideas) with:
