...
3. **Path mapping**: Paths don't match between qBittorrent, Arr, and Torrentarr
...
1. Mount qBittorrent download directory to Torrentarr container
...
- [GitHub Issues](https://github.com/Feramance/Torrentarr/issues) for bugs
- [GitHub Discussions](https://github.com/Feramance/Torrentarr/discussions) for feature ideas
...
1. **qBittorrent behind VPN**: Torrentarr and Arr instances access qBit normally
...
4. Verify Torrentarr detects torrents

**From manual scripts:**
1. Identify what scripts do
2. Configure equivalent Torrentarr features
3. Test in parallel
...
- Using cron to restart Torrentarr at specific times
...
1. Torrentarr → manages qBittorrent torrents
...
1. Go to [GitHub Issues](https://github.com/Feramance/Torrentarr/issues)
2. Click "New Issue"
3. Include:
   - Torrentarr version
   - Installation method
...
- 💬 **Community Support**: [GitHub Discussions](https://github.com/Feramance/Torrentarr/discussions)
- 🐛 **Bug Reports**: [GitHub Issues](https://github.com/Feramance/Torrentarr/issues)
