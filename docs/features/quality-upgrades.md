...
Torrentarr can automatically upgrade your existing media to higher quality versions, ensuring your library continuously improves as better releases become available.

---

## Overview

Quality upgrading is a continuous process where Torrentarr:
...
- Torrentarr queries Radarr for **all movies** (not just missing)
...
- Torrentarr checks each movie's quality against quality profile cutoff
...
- Torrentarr checks custom format scores against profile requirements
