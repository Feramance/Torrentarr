...
1. Torrentarr detects download failure
...
1. Torrentarr monitors your library for quality-unmet items
...
2. Torrentarr temporarily switches it to "Any (MP3-320)"
3. Lidarr finds and downloads an MP3 release
4. After import, Torrentarr switches back to "Lossless (FLAC)"
...
1. Torrentarr monitors `FreeSpaceFolder` disk usage
...
- [GitHub Issues](https://github.com/Drapersniper/Torrentarr/issues) - Report bugs or request features
...
- [Installation](../getting-started/installation/index.md) - Install Torrentarr
