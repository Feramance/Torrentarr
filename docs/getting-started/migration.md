...
3. **Review release notes:**
   - Check [CHANGELOG.md](https://github.com/Feramance/Torrentarr/blob/master/CHANGELOG.md) for breaking changes
   - Review [GitHub Releases](https://github.com/Feramance/Torrentarr/releases) for version-specific notes
...
2. **Old data is cleaned up** on first startup
   ...
   - You'll see: `Database migration: Removed X old records without ArrInstance. Torrentarr will repopulate data from Arr instances.`
...
1. **Identify script functionality:**
   ...
   - Match to Torrentarr features

2. **Configure equivalent Torrentarr settings:**
...
3. **Test Torrentarr:**
   ...
   - Verify Torrentarr handles all functionality
