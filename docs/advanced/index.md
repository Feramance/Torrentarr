...
Torrentarr uses a multi-process architecture:
...
```
qBittorrent → Torrentarr → Process Torrents → Arr Instance
     ↓                        ↓                  ↓
...
Configure what Torrentarr checks:
...
Torrentarr automatically cleans old data:
...
Torrentarr reuses HTTP connections:
...
```bash
# Check if Torrentarr is running
...
- Review [AGENTS.md](https://github.com/Feramance/Torrentarr/blob/master/AGENTS.md)
- Join discussions on [GitHub](https://github.com/Feramance/Torrentarr/discussions)
