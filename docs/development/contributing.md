...
2. **Clone your fork:**
   ```bash
   git clone https://github.com/your-username/Torrentarr.git
   cd Torrentarr
   ```
...
- Follow the [Code of Conduct](https://github.com/Feramance/Torrentarr/blob/master/CODE_OF_CONDUCT.md)
...
Thank you for making Torrentarr better!
